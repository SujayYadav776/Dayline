...
a = Analysis(
    ...
    datas=[
        ...
        (str(assets_dir / "paper.png"), "dayline/ui/assets"),
        (str(assets_dir / "ribbon.png"), "dayline/ui/assets"),
        (str(assets_dir / "person.png"), "dayline/ui/assets"),
        (str(assets_dir / "share.png"), "dayline/ui/assets"),
        (str(assets_dir / "snap.wav"), "dayline/ui/assets"),
        (str(assets_dir / "fonts"), "dayline/ui/assets/fonts"),
    ],
