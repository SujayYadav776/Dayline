...
- [ ] Settings dropdowns: Theme / Sort tasks by / Week starts on each open a card popup listing every option with the current one tinted; picking an option applies it live and closes the popup; clicking outside closes without changing.
